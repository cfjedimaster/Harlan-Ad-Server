<!---
	Name:			/reports_clients.cfm
	Last Updated:	06/02/05
	History:
--->

<cfparam name="form.clients" default="">
<cfparam name="form.style" default="html">

<cfset stats = application.clientManager.getClientStats(form.clients)>
...
<cfif form.style is "html">
	...
	<cfmodule template="tags/layout.cfm" title="#application.title# - Client Reports">
